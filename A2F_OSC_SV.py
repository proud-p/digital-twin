...
class VoiceResponder:
    def __init__(self, prim_path='/World/audio2face/PlayerStreaming', wsl_ip="172.30.40.252", wsl_port=5009):
        ...
        self.playing = False
        self.x = 1.0  # Default non-zero to block voice initially
        self.y = 1.0
        ...
        threading.Thread(target=self._listen_for_voice_input, daemon=True).start()
    ...
    def _listen_for_voice_input(self):
